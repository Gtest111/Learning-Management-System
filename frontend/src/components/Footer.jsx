          ...
          <div className="row py-4">
            ...
            <div className="col-lg-3 col-md-4 my-sm-0 mt-4">
              ...
              <ul className="list-unstyled text-light light-300">
                <li className="pb-2">
                  <i className='bi-chevron-right'></i>
                  <NavLink className="text-decoration-none text-light" to="/courses" exact>Office Automation</NavLink>
                </li>
                <li className="pb-2">
                  <i className='bi-chevron-right'></i>
                  <NavLink className="text-decoration-none text-light" to="/courses" exact>Web Development</NavLink>
                </li>
                <li className="pb-2">
                  <i className='bi-chevron-right'></i>
                  <NavLink className="text-decoration-none text-light" to="/courses" exact>Data Analysis</NavLink>
                </li>
                <li className="pb-2">
                  <i className='bi-chevron-right'></i>
                  <NavLink className="text-decoration-none text-light" to="/courses" exact>Digital Marketing</NavLink>
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-3 col-md-4 my-sm-0 mt-4">
              ...
              <ul className="list-unstyled text-light light-300">
                ...
                <li className="pb-2">
                  <i className='bi-chevron-right'></i>
                  <a className="text-decoration-none text-light" href="pathshala@gmail.com">pathshala@gmail.com</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="row pt-2">
              <div className="col-lg-6 col-sm-12">
                <p className="text-lg-start text-center text-light light-300">
                  &copy; Copyright {(new Date().getFullYear())} Caffeinated Coders Company. All Rights Reserved.
                </p>
              </div>
              <div className="col-lg-6 col-sm-12">
                <p className="text-lg-end text-center text-light light-300">
                  Designed by <a rel="noreferrer" className="text-decoration-none text-light" href="/" target="_blank"><strong>Caffeinated Coders</strong></a>
                </p>
              </div>
            </div>
          </div>
